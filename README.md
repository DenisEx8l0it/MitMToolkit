# 🕷 MitMToolkit - Комплексный инструмент для тестирования Man-in-the-Middle и DoS атак
...
**MitMToolkit** - Мощный инструмент для тестирования сетевых атак с поддержкой ARP спуфинга и Denial of Service 🌐

### Проект включает два основных модуля атак:
- **ARP Spoofing** - перехват сетевого трафика через подмену ARP-таблиц
- **Denial of Service (DoS)** - тестирование устойчивости сетевых сервисов к нагрузке
